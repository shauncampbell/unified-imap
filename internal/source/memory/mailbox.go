// Package memory provides an in memory implementation.
package memory
...
// delimiter is the path delimiter
var delimiter = "/"

// Mailbox represents a users mailbox.
type Mailbox struct {
	Subscribed bool
	Messages   []*Message
...
// Name provides the name of the mailbox.
func (mbox *Mailbox) Name() string {
	return mbox.name
}

// Info provides information about the  mailbox
...
// SetSubscribed sets the subscription status of the mailbox.
func (mbox *Mailbox) SetSubscribed(subscribed bool) error {
	mbox.Subscribed = subscribed
	return nil
}

// Check checks the mailbox.
func (mbox *Mailbox) Check() error {
	return nil
}

// ListMessages lists all of the messages in the mailbox.
...
// SearchMessages searches the messages in the mailbox.
...
// CreateMessage creates a message in the mailbox.
...
// UpdateMessagesFlags updates the flags on messages.
